/**
 * Nonresident index chart calculator
...
(function () {
    ...
    var scholarships = [
        { min: 115, name: 'Mt Ogden Scholarship', annual: '$9,000', total: '$36,000', band: 'band-moench' },
        { min: 105, name: 'Golden Spike Scholarship', annual: '$8,250', total: '$33,000', band: 'band-dixon' },
        { min: 90, name: 'Waterfall Canyon Scholarship', annual: '$7,500', total: '$30,000', band: 'band-tracy' }
    ];
    var noAwardMsg = 'Your index score is below 90. You may still qualify for other aid. See <a href="https://www.weber.edu/FinancialAid/nonresident.html">Aid for Non-Utah Residents</a>.';
